...
The latent S2 macro F1 of 0.4249 exceeds the 0.392 unaugmented result reported by Ma et al., while the original-69 S2 baseline reaches 0.5406 compared with their 0.506 FSLLM result \cite{Ma2025FSLLM}. These values are indicative rather than head-to-head: their study uses a 70:30 split and 13 selected features, whereas this work uses an 80:20 stratified split and all 69 cleaned features.
